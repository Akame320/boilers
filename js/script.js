$(function () {
    ...
    $(".questions__row-title").on("click", function () {
       $(this).toggleClass("active").next().slideToggle(300);
       if ($(".questions__container").hasClass("one")){
           $("questions__row-title").not($(this)).removeClass("active");
           $(".questions__row-body").not($(this).next()).slideUp(300);
       }
    });
...
function customResize() {
    ...
    $("#footer-inform").css("padding-left", ss);
